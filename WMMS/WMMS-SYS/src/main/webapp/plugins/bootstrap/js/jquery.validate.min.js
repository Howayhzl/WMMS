	...
	return $(selector).validate({
		...
		errorPlacement: function (error, element) {
			if(""!=error.html()&&element.parent().parent().find("em").html()==""){
				element.parent().find("#err").html("<span style=\"width: 40%;color: red;\"><img src=\""+projectName+"/static/image/error.png\"/>"+error.html()+"</span>");
			}else if(""!=error.html()&&element.parent().parent().find("em").html()!=""){
				element.parent().find("#err").html("");
				element.parent().find("#err").html("<span style=\"width: 40%;color: red;\"><img src=\""+projectName+"/static/image/error.png\"/>"+error.html()+"</span>");
			}else if(""==error.html()&&element.parent().parent().find("em").html()==""){
				element.parent().find("#err").html("<span style=\"width: 40%;color: green;\"><img src=\""+projectName+"/static/image/right_1.png\"/>验证成功</span>");
			}else if(""==error.html()&&element.parent().parent().find("em").html()!=""){
				element.parent().find("#err").html("");
				element.parent().find("#err").html("<span style=\"width: 40%;color: green;\"><img src=\""+projectName+"/static/image/right_1.png\"/>验证成功</span>");
			}
